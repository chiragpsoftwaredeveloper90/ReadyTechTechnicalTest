...
namespace CoffeeMachinMgmtSystem.Test
{
    ...
    public class CoffeeMachineControllerTest
    {
        ...
        /// </summary>
        [Fact]
        public void BrewCoffee_ReturnsOk_WhenCoffeeIsReady()
        {
            ...
            _mockService.Setup(s => s.BrewCoffee()).Returns(expectedMessage);
        ...
        /// </summary>
        [Fact]
        public void BrewCoffee_ReturnsTeapotStatus_WhenItIsTeapotDay()
        {
        ...
        /// </summary>
        [Fact]
        public void BrewCoffee_ReturnsServiceUnavailable_WhenOutOfCoffee()
        {
            // Arrange
            _mockService.Setup(s => s.IsTeapotDay(null)).Returns(false);
        ...
        /// </summary>
        [Fact]
        public void BrewCoffee_ReturnsBadRequest_OnException()
        {
